export default function Home() {
	return (
	  <main>
		...
		<h2>Exchange Semester 2023 USA</h2>
		...
		<h3>Preperations</h3>
		<p>
			Around one year before my planned trip, the preperations started. There was in infinite amount of documents that had to be filled out, vaccines I had to get and health test I had to do. After these exhausting 12 months I was sitting at home, my luggage already packed up, going to sleep to be ready for my big day. The day I'd cross the ocean and explore a new continent - at least that's what it felt like.
			After _Waking Up_ I saw the text from my hostdad Ben 'Hope you got some sleep' - not at all - no sleep for me on the recipe.
		</p>
		...
		<h3>15h Car Trip to Texas</h3>

		<h3>Spring Vacation Miami</h3>
