			...
			<div className="flex flex-col md:flex-row w-11/12 bg-white text-black py-[5rem] h-full rounded-2xl shadow shadow-2xl">
				<div className="flex w-full md:w-1/3 justify-center">
					<div className="flex flex-col w-3/4 text-center">
						<h3 className="text-2xl font-semibold">Cloud Architecture</h3>
						<p className="text-xl mt-5">The future is cloud. I am currently studying for the AWS Certified Solutions Architect Certificate</p>
					</div>
				</div>
				<div className="flex w-full md:w-1/3 justify-center">
					<div className="flex flex-col w-3/4 text-center">
						<h3 className="text-2xl font-semibold">Data Science</h3>
						<p className="text-xl mt-5">Everybody knows ChatGPT. It’s incredible what AI can do these days. I decided to pusue the Data Science branch in my current school to learn how to develop such huge data models.</p>
					</div>
				</div>
				<div className="flex w-full md:w-1/3 justify-center">
					<div className="flex flex-col w-3/4 text-center">
						<h3 className="text-2xl font-semibold">Cybersecurity</h3>
						<p className="text-xl mt-5">I received the TestOut CyberDefense Pro Certification and deeply focused onto Windows vulnerabilies, since I found this the most interesting.</p>
					</div>
				</div>
			</div>
		</div>
